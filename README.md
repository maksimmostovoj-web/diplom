...
<details>
<summary><b>🖥️ UI (RealWorld)</b></summary>
...
<details>
<summary><b>🔌 API (Apichallenges)</b></summary>
...
```html
<b>Результаты:</b> <b>Рабочее окружение:</b> test <b>Комментарий:</b> Дипломный
проект JS <b>Продолжительность:</b> 00:03:35 <b>Всего сценариев:</b> 15
<b>Успешных:</b> 15 (100%) <b>Упавших:</b> 0 (0%) <b>Пропущенных:</b> 0
...
| `npx playwright test api.spec.js` | Запуск API тестов  |
| `npx playwright test ui.spec.js`  | Запуск UI тестов   |
...
| --------------------- | ----------------------------------- |
| `npm run report`      | Открыть встроенный отчёт Playwright |
| `npx allure generate` | Сгенерировать Allure-отчёт          |
| `npx allure open`     | Открыть Allure-отчёт в браузере     |
...
- ✅ Все команды можно копировать по одной (кнопка 📋 при наведении)
